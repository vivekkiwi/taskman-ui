...
import { _get } from "@utils/fn-utils";
...
class Collapse extends React.Component {
  ...
  render() {
    const { theme, children, isOpened, contentContainerClassName } = this.props;
    return (
      <div
      ...
      >
        <div ref={this.onRefContent} className={contentContainerClassName}>
          {_get(children, "props.children")}
        </div>
      </div>
    );
  }
